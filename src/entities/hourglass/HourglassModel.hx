...
/**
	...
	dependency (see `docs/rules/guidelines.md` §1.4/§5.4 for why this is unit-tested
	...
	This is `docs/open/ideas-backlog.md`'s own backlogged "Hourglass game-speed
	...
	**Hidden mechanic: pushing past the minus floor, repeatedly, unlocks
	...
	to `unlocked` yet. This is the same idea `docs/open/ideas-backlog.md`'s own
