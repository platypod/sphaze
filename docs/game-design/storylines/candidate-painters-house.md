...
progression than the Garden of Eden candidate — its strengths are place
and ending, its driver is restoration (warm, melancholy, finite). Composes
with the Twisted mythologies candidate: "the painter painted the myths
wrong" is a possible skin for that engine.
